        ...
        <div class="row ">
            <div class="col-lg-6 col-md-1">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h1 class="big_title" id="change">Transforme a sua presença digital</h1>
                    </div>

                    <div class="col-12">
                        <p class="mt-5"> Crio estratégias de conteúdo que conectam marcas ao seu público,</p>
                        <p>através do engajamento real e resultados mensuráveis.</p>
                    </div>
